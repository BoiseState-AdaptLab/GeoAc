...
void    GeoAc_SetInitialConditions(double**&, double, double, double,   // Function sets initial conditions for a source at (x_0, y_0, z_0) with launch angles 
                                   double, double);                     // GeoAc_theta, GeoAc_phi
