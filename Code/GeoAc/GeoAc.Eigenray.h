...
// Modified to pass GeoAc_ angles by reference
bool GeoAc_EstimateEigenray(double [3], double [2], double, double, double &, double &, double &, int, double, double &, double &);  // Function to identify inclination at fixed azimuth for specified arrival range
void GeoAc_3DEigenray_LM(double [3], double [2], double &, double &, double, int, int, char [], double &, double &);       // Function to identify exact eigenray
